...
public class Server implements ActionListener {
    ...
    Server() {
        ...
        moreOptions.setBounds(375, 23, 15, 20);
        p1.add(moreOptions);

        JLabel name = new JLabel("Vivan");
        ...
        send.setBounds(325, 610, 75, 40);
        send.setBackground(new Color(7, 94, 84));
        send.setForeground(Color.WHITE);
        send.addActionListener(this);
        send.setFont(new Font("SAN SERIF", Font.PLAIN, 10));
        f.add(send);
